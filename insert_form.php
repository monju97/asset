...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql = "INSERT INTO asset_info (name, pc_model, serial_no, ram, ssd, hdd, ip, internet_access, pc_name, domain_name, mail_id, ip_phone, keyboard, mouse, monitor, ups, windows_version, department, asset_code,emp_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$sql1 = "SELECT * FROM asset_info ORDER BY id DESC LIMIT 1";
