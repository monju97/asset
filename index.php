...
$conn = new mysqli('localhost', 'root', '', 'maf_it_asset');
...
$sql = "SELECT * FROM asset_info order by id desc limit 5";
...
<table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
 ...
 <tr>
    ...
    <td>
    <!--   /* //Using Script */ -->
    <button hight=30px onclick="AddItem()">New Product Entry</button>
...
<table>
    ...
    <tr>
    <td>Device Type:</td>
    <td><label> <input type="radio" name="device" value="0" required> Desktop </label>
        <label> <input type="radio" name="device" value="1" required> Laptop </label> </td>
